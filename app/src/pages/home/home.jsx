  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="bg-amber-50 border-b border-amber-100 py-2 px-4 text-center">
          <p className="text-sm text-amber-800 font-medium">
            🚀 PixMind está en modo <span className="font-bold">MVP</span>. Los modelos se despliegan bajo demanda para demostraciones privadas.
          </p>
        </div>

        {/* Project Status & Investment Section */}
        <ProjectStatus />
      </div>
      ...
      <div className="flex flex-col min-h-screen bg-white">
          ...
          <div className="md:w-1/2 flex justify-center mb-10 md:mb-0 hover:scale-105">
            <div className="relative w-80 h-80 rounded-xl overflow-hidden">
              ...
              <img
                src="/City.png"
                alt="Imagen"
                className="w-full h-full object-cover hover:shadow-2xl"
              />
        ...
        {/* Features Section */}
        <section id="roadmap" className="px-8 py-20 bg-white max-w-6xl mx-auto">
